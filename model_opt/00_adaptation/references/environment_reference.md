...
> Phase 0 模型适配与 profiling 采集的次级参考：诊断命令、torch_npu 验证代码、环境变量清单、版本配套确认、常见报错。

## 目录

- [1. 环境诊断命令](#1-环境诊断命令)
- [2. torch_npu 验证代码片段](#2-torch_npu-验证代码片段)
- [3. 环境变量配置清单](#3-环境变量配置清单)——基础 / 性能 / Python 级
- [4. 版本配套确认方法](#4-版本配套确认方法)
- [5. 常见报错及解决方案](#5-常见报错及解决方案)
